...
def server_start() -> None:
    ...
    from lociaction.embedder import _loci_python
    from lociaction.embedder_server import ping_server
    from lociaction.paths import db_path, find_project_root, server_pid_path, sock_path
    ...
    try:
        ...
        proc = subprocess.Popen(
            [_loci_python(), "-m", "lociaction.embedder_server", str(sock)],
