...
git history + `.lociaction/memory.db`. `loci eval run` executes the `symbol`
...
from lociaction.eval.gate import DEFAULT_BASELINE_PATH
...
def eval_gen(
    ...
    from lociaction.eval.datasets.schema import dataset_path, dump_dataset
    from lociaction.eval.gen.gen_symbol_recall import generate_symbol_recall_queries
